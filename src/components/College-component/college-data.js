...
export default class CollegeData extends Component{
  constructor(props){
      super(props);
      this.state = {
          courses: [],
...
submitCourse=()=>{
    ...
    render(){
        ...
        return(            
            <div className="col_data_bg" >
                <div className="head_college"><b><i>College Logged In</i></b>
              ...
              <Container>
                ...
                <div>
                    {/* hello hi everyone */}
                   <Button className="sub_cou" onClick={this.submitCourse} variant="outlined" color="primary" >
                      <b> Submit Courses</b>
                   </Button>
                 </div>
          </div>
